...
class Products(Resource):
    def get(self, episode_id):
        ...
        for i in comment_list:
            ...
            comment_data["comment"] = tostring(html.xpath(f'//div[@name="{i}"]/div[2]/div/div[@class="message clearit"]')[0], encoding="utf-8").decode("utf-8").replace('<div class="message clearit">','').replace('</div>\n','')
